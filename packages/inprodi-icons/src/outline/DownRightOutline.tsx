  ...
  return (
    ...
    >
      <g clipPath="url(#DownRightOutline_svg__a)">
        <path
          d="M.492 1.84A.5.5 0 0 0 0 2.347v5c0 1.007.827 1.834 1.833 1.834h10.46l-2.48 2.48a.501.501 0 1 0 .707.707l3.334-3.334a.5.5 0 0 0 0-.707L10.52 4.994a.5.5 0 1 0-.707.707l2.48 2.48H1.833A.826.826 0 0 1 1 7.347v-5a.5.5 0 0 0-.508-.507Z"
